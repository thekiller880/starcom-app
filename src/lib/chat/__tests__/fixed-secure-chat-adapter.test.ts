/**
 * Fixed SecureChatAdapter.test.ts
 * 
...
// Create a dedicated mock service for our tests
...
// Mock the service import at the module level
vi.mock('../../../services/SecureChatIntegrationService', () => {
  return {
    SecureChatIntegrationService: {
      getInstance: vi.fn().mockImplementation(() => createMockService())
    }
  };
});
